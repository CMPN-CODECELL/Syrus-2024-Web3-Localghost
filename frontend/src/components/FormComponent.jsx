...
if (window.ethereum) {
  ...
  // Handle the case where the user doesn't have MetaMask or any other Ethereum-compatible browser extension
  console.log(
...
const FormComponent = () => {
  ...
  const ABI = [
    ...
    },
    {
      inputs: [
        ...
        {
          internalType: "enum VaccineTokenNew.Role",
          name: "_role",
          type: "uint8",
        },
      ],
  ...
  const ADDRESS = "0xd3f725c0cbc4D35C1d796A280a0D03EB16aB0D62";
