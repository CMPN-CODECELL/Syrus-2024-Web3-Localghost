...
const Login = () => {
  ...
  const handleMetaMaskLogin = async () => {
    ...
    try {
      ...
      if (isValidAddress) {
        setError("");
        console.log(
          "Wallet address validation successful for role:",
          selectedRole
        );
  ...
  const validateWalletAddress = async (role, address) => {
    ...
    const validAddresses = {
      admin: [
        "0x6a2e7fdfffcb45844c8482d4e828fb86ecd29fa7" /* Add more admin addresses as needed */,
      ],
      user: [
        "0x469cB9016ee68AAA195416708562f6D3b2e09d0D" /* Add more user addresses as needed */,
      ],
    ...
    if (role === "admin") {
      if (
        address === "0x6a2e7fdfffcb45844c8482d4e828fb86ecd29fa7" ||
        address === "0x11fac33125adba1419be146191c84e202caa5407"
      ) {
        return true;
      } else {
        return false;
      ...
      if (
        address === "0xbdc2109abed65d2d2abd30c5882d2c854aa5a094" ||
        address === "0xd51cd7068f8c27b3486b94ed77fdd35000b9e43c"
      ) {
        return true;
      } else {
        return false;
